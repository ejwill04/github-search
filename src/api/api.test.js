...
test("getTotalPages finds the the last page", () => {
  const res = {
    headers: {
      link:
        '<https://api.github.com/search/repositories?per_page=30&page=2&q=thing>; rel="next", <https://api.github.com/search/repositories?per_page=30&page=34&q=thing>; rel="last"',
    },
  };
